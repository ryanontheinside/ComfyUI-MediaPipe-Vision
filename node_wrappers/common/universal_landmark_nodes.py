...
from ...src.utils.comfy_utils import AlwaysEqualProxy
...
class LandmarkPositionBaseNode:
    ...
    CATEGORY = "MediaPipeVision/Common/Utils" 
...
class PositionDeltaControlNode(BasePositionDeltaNode):
    ...
    DEFAULT_CLAMP = True
    CATEGORY = "MediaPipeVision/Common/Delta"
...
class UniversalLandmarkMaskNode:
    ...
    """
    CATEGORY = "MediaPipeVision/Common/Masking"
